var Maze = {
    ...
    init: function() {
        this.board = [
            ["NW" ,"P"  ,"NE" ,"N"  ,"NE" ,"N"  ,"NS" ,"NS" ,"NE" ,"NS" ,"N"  ,"NS" ,"NS" ,"NE" ,"N  ","NS" ,"NSE","N"  ,"NE" ], // 0
            ["W"  ,""   ,"G"   ,""   ,"E"  ,"S"   ,"S"  ,"E"  ,""   ,"S"  ,"SE" ,""   ,"SE" ,"E"  ,""   ,"S"  ,"S"  ,"SE" ,"SE" ],
            ["SW" ,"S"  ,"E"  ,""   ,""   ,""   ,"S"  ,"SE" ,"B"   ,"S"  ,"S"  ,"E"  ,""   ,""   ,""   ,""   ,"S"  ,"S"  ,"E"],
            ["W"  ,"F"  ,"F"  ,"F"  ,"F"  ,"F"  ,""   ,""   ,""   ,""   ,""   ,"F"  ,"F"  ,"F"  ,"F"  ,"F"  ,""   ,""   ,"E"],
            ["W"  ,"F"  ,"S"  ,""   ,"S"  ,"S"  ,""   ,""   ,""   ,""   ,""   ,"S"  ,"S"  ,"S"  ,"S"  ,"E"  ,""   ,""   ,"E"],
            ["W"  ,"F"  ,""   ,""   ,""   ,"E"  ,""   ,""   ,""   ,""   ,"E"  ,""   ,""   ,""   ,""   ,"E"  ,"S"  ,"S"  ,"SE"],// 5
            ["W"  ,"F"  ,""   ,""   ,"E"  ,"E"  ,"S"  ,"R"   ,""   ,""   ,"SE" ,""   ,""   ,"S"  ,"S"  ,"S"  ,"S"  ,"S"  ,"E"], 
        ...
        this.doorsLeft[3] = new Door("purple", "N", [1,0]);
        ...
        if(delta[0] === 0 && delta[1] === 0){
            ...
            if(delta[0] === -1){
                ...
                if(this.board[start[1]][start[0]].includes("E") || this.board[end[1]][end[0]].includes("W") 
                    ...
                    ret = false;
                }else if(this.board[start[1]][start[0]].includes("G")){
                    if(this.doorsLeft[0].open){
                        ret = true;
                    }
                }else{
                    ret = true;
                ...
                if(this.board[start[1]][start[0]].includes("S") || this.board[end[1]][end[0]].includes("N")
                                                                || this.board[end[1]][end[0]].includes("F")){
                    ret = false;
                }else if(this.board[start[1]][start[0]].includes("B")){
                    if(this.doorsLeft[1].open){
                        ret = true;
                    }
                }else if(this.board[start[1]][start[0]].includes("R")){
                    if(this.doorsLeft[2].open){
                        ret = true;
                    }
                }
                else{
    ...
    //    if(ret){
    //         this.crossDoors(pos1);
    //     }
        
        return ret;
    },

    // crossDoors: function(pos1){
    //     let loc = vec3.create();
    //     vec3.copy(loc, pos1);
    //     loc[1] = 0;

    //     for(let i = 0; i < 4; i++){
    //         let dist = this.distance(loc, this.doorsLeft[i].getLocation());
    //         if(dist <= .96 && !this.doorsLeft[i].open){
    //             return false;
    //         }
    //     }
