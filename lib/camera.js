 ...
 */
Camera.prototype.checkWalk = function(delta) {
    let d = delta * 0.75;
    let new_position = vec3.create();
    vec3.copy(new_position, this.eye);  //The new position starts as a copy of this.eye
 ...
 * @return {vec3} a vec3 representing the new position of the camera
 */
Camera.prototype.checkTrack = function(dx, dy) {
    dx = dx * 0.75;
    dy = dy * 0.75;
