...
var Camera = function(aspect) {
    ...
    this.acceleration = 0.01;     // The acceleration due to gravity.
    ...
    this.lookAt( vec3.fromValues(0,0.7,10), vec3.fromValues(0,0,0), vec3.fromValues(0,1,0) );
...
Camera.prototype.walk = function(delta) {
    let d = delta * 0.75;
    let n = vec3.fromValues(this.rotation[2], 0, this.rotation[10]);
    vec3.scaleAndAdd(this.eye, this.eye, n, d);
};
